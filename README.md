...
This is a professor-readable AI Engineering project built around **real data**, an explicit processing mechanism, executable code, empirical evaluation, and a scientific-style technical report. It demonstrates **PyTorch, CNN, computer vision, training loop** without hiding the data-processing choices inside an opaque notebook.
